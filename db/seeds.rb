...
order3 = Order.create!(v_id: 13, customer_name: "Alex Smith", order_ref: "#P-1325002", source: 'web')
...
OrderItem.create!(price: 20.00, sku: "SUP-008",image_url: "https://www.scotclans.com/wp-content/uploads/2011/04/scotclans-tartan-paint1.jpg", title: "1 Tin of Tartan Paint", order: order2, height: 5, width: 4, depth: 4, weight: 2)
...
OrderItem.create!(price: 2.00, sku: "SUP-008",image_url: "http://i.imgur.com/bLeDN2r.jpg", title: "1 Ounce Oregano", order: order4, height: 5, width: 5, depth: 5, weight: 2)
